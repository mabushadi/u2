...
window.hypothesisInstall = function (inject) {
  ...
  if (typeof window.Annotator === 'undefined') {
    resources = resources.concat(['https://hypothes.is/assets/icomoon.css', 'https://hypothes.is/assets/styles/hypothesis.min.css?6f1f0e4c', 'https://hypothes.is/assets/scripts/hypothesis.min.js?5d0404b1']);
  }
